...
if (
  ...
  document.querySelector("a[href='/index'").parentElement.classList.add('active')
}
...
if (window.location.href.includes('recharge')) {
  document.querySelector("a[href='/recharge'").parentElement.classList.add('active')
}
...
if (window.location.href.includes('buyCardMobile')) {
  document.querySelector("a[href='/buyCardMobile'").parentElement.classList.add('active')
}
